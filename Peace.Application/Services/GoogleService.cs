...
{
	public class GoogleService : ISocialMediaService
	{
        private readonly SocialMediaServiceSettings _socialMediaServiceSettings;
        private readonly IHttpClientWrapper _httpClientWrapper;

        public GoogleService(IHttpClientWrapper httpClientWrapper, IConfiguration configuration)
        {
            _httpClientWrapper = httpClientWrapper;
            _socialMediaServiceSettings = (SocialMediaServiceSettings)configuration.GetSection("GoogleServiceSettings");
        }
