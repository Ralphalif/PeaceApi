...
namespace Peace.Application.Services
{
	public class InstagramService : ISocialMediaService
    {
        ...
        public InstagramService(IHttpClientWrapper httpClientWrapper, IConfiguration configuration)
        {
            _httpClientWrapper = httpClientWrapper;
            _socialMediaServiceSettings = (SocialMediaServiceSettings)configuration.GetSection("InstagramServiceSettings");
        }
