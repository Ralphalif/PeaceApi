...
namespace Peace.Application.Services
{
	public class TwitterService : ISocialMediaService
    {
        ...
        public TwitterService(IHttpClientWrapper httpClientWrapper, IConfiguration configuration)
        {
            _httpClientWrapper = httpClientWrapper;
            _socialMediaServiceSettings = (SocialMediaServiceSettings)configuration.GetSection("TwitterServiceSettings");
        }
